'''
@Description: cifar-10 with data agumentation
@Version: 1.0
@Autor: Vicro
@Date: 2020-07-25 22:58:37
LastEditors: Vicro
LastEditTime: 2020-08-28 10:05:29
...
for epoch in range(n_epochs):
    ...
    if epoch % 20 == 0:
        torch.save(model.state_dict(),
                   ("./checkpoint_data_agumentation/model"+str(time.time())+".pkl"))


torch.save(model.state_dict(), ("./checkpoint_data_agumentation/model"+str(time.time())+".pkl"))
