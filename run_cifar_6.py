'''
Description: Change VGG-Net dropout
Version: 1.0
Autor: Vicro
Date: 2020-09-02 13:28:51
LastEditors: Vicro
LastEditTime: 2020-09-02 16:43:10
'''
...
BATCH_SIZE = 200
n_epochs = 2000
checkpoint_path = "Z:/STUDY/checkpoint/checkpoint_Ebbinghaus/05/prigin2/"
train_path = "Y:/2020/Ebbinghaus-Cifar10/cifar10_train"
WHETHER_MODEL = True
WHETHER_LOG = True
LOG_NAME = 'vgg16-pro2.txt'
...
# model.features = torch.nn.Sequential(torch.nn.Conv2d(3, 64, kernel_size=3, padding=1),
...
def Train():
    ...
    for epoch in range(n_epochs):
        ...
        if (epoch+1)%20 == 0:
            if WHETHER_MODEL:
                torch.save(model.state_dict(), (checkpoint_path+"model_batch"+str(epoch+1)+".pkl"))
