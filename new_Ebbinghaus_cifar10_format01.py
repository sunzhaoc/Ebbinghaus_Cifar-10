...
LastEditors: Vicro
LastEditTime: 2020-08-24 09:22:35
'''
...
def Train(step, model, BATCH_SIZE, optimizer, scheduler, cost, use_gpu):
    ...
    for data in data_loader_image:
        ...
        print("Step: {} Batchsize: {} Ave_Loss: {:.5f} Ave_Acc: {:.2f} Step_Loss: {:.5f} Step_Acc: {:.2f} All_data: {}".format(
                                                                    step, 
                                                                    BATCH_SIZE,
